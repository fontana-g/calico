...
(* ::Text:: *)
(*This example computes differential equations (DEs) for the L-loop equal mass banana integral family, using the Schwinger representation.*)
...
ann = CATAnnihilator[twist,zs,L+1,1]; //AbsoluteTiming
...
(* ::Text:: *)
(*We merge second-order annihilators into `ann`*)
